...
const NFTCountDown = () => {
  return (
    <div
      className="bg-top bg-no-repeat bg-cover desktop:bg-center"
        ...
        <div className="max-w-[1050px] mx-auto">
          ...
          <div className="tablet:mt-7.5 grid grid-rows-1 tablet:grid-rows-2 tablet:col-start-1 tablet:gap-x-5 tablet:max-h-min">
            <Typography
              ...
              className="my-7.5 tablet:my-0 desktop:text-h2"
            >
              Magic Mushrooms
            </Typography>

            {/* Countdown */}
            <div className="bg-dark-gray/50 p-7.5 rounded-brand tablet:row-span-full tablet:col-start-2 desktop:max-w-xs desktop:w-full desktop:ml-auto">
